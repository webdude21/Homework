...
namespace SelectNumbersFromArray
{
    using System;
    using System.Linq;

    internal class SelectNumbersFromArray
    {
        private static void Main()
        {
            // Generate test Array
            var testArr = new int[200];
            ...
            var selectedNumbers = from number in testArr where number % 21 == 0 select number;
