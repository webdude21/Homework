...
namespace SelectStudentsByAge
{
    using System;
    using System.Linq;

    internal class SelectStudentsByAge
    {
        private static void Main()
        {
            ...
            var slectedStudents = from student in students where student.Age >= 18 && student.Age <= 24 select student;
