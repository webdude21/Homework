    ...
    class Zoo
    {
        static void Main()
        {
            Animal[] animals = new Animal[]{
                new Tomcat("Tom", 5),
                new Frog("Toad", 3, Sex.Male),
                new Kitten("Mimi", 4),
                new Dog("Lassie", 10, Sex.Female),
                new Cat("Emy", 2, Sex.Female),
            ...
            {
                new Dog("Lassie", 10, Sex.Female),
                new Dog("Sharo", 15, Sex.Male),
                new Dog("Murdjo", 40, Sex.Male),
                new Dog("Bethoven", 20, Sex.Male),
