namespace Bookstore.XmlImport
{
    ...
    internal class XmlImport
    {
        ...
        private static void ExtractAuthors(BookstoreDbContext bookstoreDbContext, XElement authorsElement, ICollection<Author> authors)
        {
        ...
        private static void ExtractReviews(BookstoreDbContext bookstoreDbContext, XElement reviewsElement)
        {
