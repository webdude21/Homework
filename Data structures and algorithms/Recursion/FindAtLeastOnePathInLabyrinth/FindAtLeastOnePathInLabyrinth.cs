...
{
    class FindAtLeastOnePathInLabyrinth
    {
        static readonly LinkedList<char> Path = new LinkedList<char>();
        ...
        static readonly char[,] Labyrinth = new char[LabyrinthSize, LabyrinthSize];
        ...
        private static void Move(int row, int col)
        {
            ...
            Labyrinth[row, col] = Blocked; // Ocuppy current Cell
