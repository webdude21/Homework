<%@ Page Title="Edit books" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditBooks.aspx.cs" Inherits="Exam.WebForms.Admin.EditBooks" %>

<asp:Content ID="ContentEditBooks" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        <h1><%: this.Title %></h1>
    </div>
    <asp:GridView runat="server" ID="GridViewBooks" ItemType="Exam.WebForms.Models.Book" 
        SelectMethod="GridViewBooks_GetData" UpdateMethod="GridViewBooks_UpdateItem" 
        DeleteMethod="GridViewBooks_DeleteItem" AllowSorting="True" AllowPaging="True" 
