...
namespace RemoveTestFromTextFile
{
    using System;
    using System.IO;
    using System.Text.RegularExpressions;

    internal class RemoveTestFromTextFile
    {
        private static void Main()
        {
            ...
            fileContent = Regex.Replace(fileContent, @"\b(test\w+)", string.Empty);
            var outputFile = new StreamWriter(@"..\..\inputFile.txt");
            using (outputFile)
            {
