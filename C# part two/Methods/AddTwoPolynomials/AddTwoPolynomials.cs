...
namespace AddTwoPolynomials
{
    ...
    internal class AddTwoPolynomials
    {
        ...
        {
            decimal[] firstPolynom = { 9, -8, 5, 4, 2 };
            decimal[] secondPolynom = { 8, 2, 1 };
        ...
        private static decimal[] InputPolynomial()
        {
            ...
            for (var i = 0; i <= degree; i++)
            {
                if (i == degree)
                {
                    Console.Write("Please input the last coeficient: ");
                }
                else
                {
                    Console.Write("Please input the next coeficient: ");
                }
