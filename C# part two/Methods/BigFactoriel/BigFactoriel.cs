    ...
    internal class CalcFact
    {
        ...
        private static int GetInput()
        {
            ...
            if (n > 10000)
            {
                ...
                // I've tried it and eventually it gets calculated and printed
        ...
        private static List<int> MultiplyNumber(IReadOnlyList<int> a, int b)
        {
            var memory = 0;
        ...
        private static void PrintList(IEnumerable<int> input)
        {
            // Straight foreword printing of the list of digits
